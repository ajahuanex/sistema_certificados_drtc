...
SECRET_KEY = env('SECRET_KEY', default='django-insecure-p6yr3&r9%9=h*#$2b-6+j%--4o+_)f4$@+$@xzhu4%n5mzu#o4')
...
# Digital Signature Service Configuration (can be overridden in production)
