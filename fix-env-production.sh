#!/bin/bash
# Script para corregir .env.production en el servidor
...
# Crear archivo limpio con las variables correctas
...
echo "Archivo .env.production actualizado correctamente"
cat .env.production
